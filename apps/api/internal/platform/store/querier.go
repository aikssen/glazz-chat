...
type Querier interface {
	...
	GetDeletedGuestConversationByKey(ctx context.Context, arg GetDeletedGuestConversationByKeyParams) (Conversation, error)
	GetDeletedUserConversationByKey(ctx context.Context, arg GetDeletedUserConversationByKeyParams) (Conversation, error)
	...
	GetGuestConversationByCreationKey(ctx context.Context, arg GetGuestConversationByCreationKeyParams) (Conversation, error)
	...
	GetUserConversationByCreationKey(ctx context.Context, arg GetUserConversationByCreationKeyParams) (Conversation, error)
